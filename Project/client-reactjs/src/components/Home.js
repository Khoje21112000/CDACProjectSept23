  ...
  return (
    <>
      <div>
        ...
        <section className="section__container_2">
          <div className="eligiblity_coverage">
            <h1 style={{ fontSize: "40px", textAlign: "center" }}>
              Choose Who You're Most Likely
            </h1>
          ...
          <div className="column">
            <img src="../assets/health-thinker.png" alt="Health Thinker" />
          ...
          <div className="column">
            <img
              src="../assets/health-enthusiast.png"
          ...
          <div className="column">
            <img
              src="../assets/living-with-a-lifestyle.png"
              alt="Living with a Lifestyle Condition"
            />
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="criteria">
                    ...
                    <br />
                    Prime - Maximum of 6 Adults (Self + Spouse + set of
                    dependent Parents + set of Parents in law) and 6 children
                  </td>
                </tr>
                <tr>
        ...
        <section className="section__container_3">
          ...
          <div className="flipcard-container">
            <div className="flipcard">
              <div className="flipcard_front flipcard_side">
                <div className="flipcard__img">
                  <img
                    src="../assets/care_health_insurance_logo.png"
                ...
                <div className="flipcard__text">
                  <ul>
                    ...
                    <li>
                      ...
                      for Diabetes with 'Instant Cover' rider
                    </li>
            ...
            <div className="flipcard">
              <div className="flipcard_front flipcard_side">
                <div className="flipcard__text-img">
                  <img src="./src/assets/695.jpg" alt="Insurance Image" />
              ...
              <div className="flipcard_back flipcard_side">
                <div className="flipcard__text">
                  <ul>
                    <li className="discount">
                      Customize your own plan with additional discount up to 30%
                    </li>
            ...
            <div className="flipcard">
              <div className="flipcard_front flipcard_side">
                <div className="flipcard__text-img">
                  <img
                    src="../assets/HDFC-Life-Insurance-Logo-Small.png"
                    alt="HDFC Logo"
                  />
                  <h5 style={{ textAlign: "center", marginTop: "20px" }}>
                    {" "}
          ...
          <div className="view-more">
            {/* Use Link component to navigate to Register component */}
